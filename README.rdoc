...
The --use-winrm option can be used to bootstrap a distro or template file using the winrm functionality instead of SSH, which is not natively supported on Windows.
